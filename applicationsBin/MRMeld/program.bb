...
char *rule_names[] = {"_init -o node-axioms.", " -o (stage1(), !at(X, Y, Z), X != 3 -o stage1(), 			!moveTo(3, Y, 0)), OR (stage1(), !at(X, Y, Z), X = 3 -o stage2()).", "stage2() -o {B | !edge(B) | 			ready(host-id)@B}.", " -o (ready(B), readycount(N), N < 3 -o readycount(N + 1)), OR (ready(B), readycount(N), N = 3 -o stage3()).", " -o (stage3(), !at(X, Y, Z), Y != ((7 + node2int(host-id)) - 1) -o stage3(), 			!moveTo(X, (7 + node2int(host-id)) - 1, 0)), OR (stage3(), !at(X, Y, Z), Y = ((7 + node2int(host-id)) - 1) -o stage4()).", " -o (stage4(), !at(X, Y, Z), (X != (0 + node2int(host-id))) || (Y != 8) -o stage4(), 			!moveTo(0 + node2int(host-id), 8, 0)), OR (stage4(), !at(X, Y, Z), X = (0 + node2int(host-id)), Y = 8 -o 			stage5()).", };
